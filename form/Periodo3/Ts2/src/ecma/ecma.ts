...
const somar = function(n1: number, n2: number){     //Essa aqui é função anonima, sem nome. Para ela funcionar tem que definir ela numa constante.
    return n1 + n2;
}

function somar2 (n1: number, n2: number){     //Essa aqui é uma função normal
    return n1 + n2;
}

const subtrair = (n1: number, n2: number) => n1 - n2 //O retorno está implicito, é uma função anonima.
